...
const Header = ({
  ...
  useEffect(() => {
    if (selectedSecondOption && selectedType.value === "Teachers") {
      getTeacherInfo();
    } else if (selectedSecondOption && selectedType.value === "Groups") {
      getGroupInfo();
    } else if (selectedSecondOption && selectedType.value === "Classes") {
      getLecturesInfo();
    }
    ...
    <S.Header>
      ...
      {selectedType && (
        <Select
          ...
          options={secondOptions.map((elem) => ({
            label:
              elem[
                selectedType.value === "Classes" ? "lectureRoomNumber" : "name"
              ],
            value:
              elem[
                selectedType.value === "Groups"
                  ...
                  ? "teacherId"
                  : selectedType.value === "Classes" && "lectureRoomId"
              ],
          }))}
          placeholder="Select"
        />
